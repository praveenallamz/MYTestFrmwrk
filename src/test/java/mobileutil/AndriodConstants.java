...
public class AndriodConstants {
	...
	public static class Cloudfm {
		...
		// public static final String
		// btn_signIn="//div[contains(@id,'loginBtn')]";
		public static final String btn_signIn = "//android.view.View[@content-desc='Sign in']";
	...
	public static class Amazon {
		...
		/*
		 * public static final String skip_sign_in_btn = "skip_sign_in_button"; public
		 * static final String shop_by_category_btn =
		 * "web_home_shop_by_department_label"; public static final String
		 * first_category_expand_btn = "//*[@text='Echo & Alexa']"; public static final
		 * String select_product_btn = "//*[@text='All new Amazon Echo']"; //public
		 * static final String first_category_expand_btn =
		 * "//android.view.View[@content-desc='Echo & Alexa']"; //public static final
		 * String select_product_btn = "//android.view.View[7]"; public static final
		 * String add_to_cart_btn = "//*[@text='Pre-order: Add to Cart']"; //public
		 * static final String add_to_cart_btn = "//*[@text='Add to Shopping Cart'']";
		 * public static final String checkout_cart_img = "action_bar_cart_image";
		 * public static final String sign_In_btn = "sign_in_button"; public static
		 * final String email_Login_txtbx = "ap_email_login"; public static final String
		 * continue_btn = "continue";
		 */

		public static final String skip_sign_in_btn = "skip_sign_in_button";
		public static final String shop_by_category_btn = "web_home_shop_by_department_label";

		public static final String first_category_expand_btn = "//*[@content-desc='Echo & Alexa']";
		public static final String select_product_btn = "//*[@content-desc='Echo Plus ']";
		//public static final String first_category_expand_btn = "//android.view.View[@text='Echo & Alexa']";
		public static final String first_category_expand_btnIndex = "//android.view.View[@index='2']";
		public static final String first_category_expand1_btn = "Echo & Alexa";

		public static final String first_category_expand_btn1 = "//*[@index='2']";
		// public static final By first_category_expand_btn =
		// MobileBy.AccessibilityId("Echo & Alexa");

		// public static final String first_category_expand_btn =
		// "(//android.widget.Image)[1]";
		// public static final String first_category_expand_btn =
		// "//android.view.View[@content-desc='Echo & Alexa']";

		// public static final String select_product_btn = "//*[@text='Add to Cart']";
		// public static final String select_product_btn = "(//android.view.View)[11]";
		// public static final String select_product_btn = "(//android.view.View)[10]";
		// public static final String select_product_btn = "//*[@text='Echo Plus']";
		// public static final By select_product_btn = MobileBy.AccessibilityId("Echo
		// Plus ");
		

		public static final String FirstElement = "//*[@text='Amazon'sChoicefor \"amazon echo plus\"]";
		//public static final String add_to_cart_btn = "//*[@resource-id='add-to-cart-button']";
		
		public static final String add_to_cart_btn = "//*[@content-desc='Add to Cart Add to Shopping Cart']";
		public static final String add_to_cart_btn1 = "//*[@resource-id='xxxxxxxxxxxxxxxxxxx']";
		public static final String add_to_cart_btn2 = "//*[@resource-id='add-to-cart-button']";
		public static final String add_to_cart_btn3 = "//*[@resource-id='add-to-cart-button']";

		public static final String checkout_cart_img = "action_bar_cart_image";
		public static final String sign_In_btn = "sign_in_button";
		
		
		public static final String sign_In_btn1 = "//*[@resource-id='gwm-SignIn-button']";
		public static final String sign_In_btn2="//android.widget.Button[@content-desc='Sign in']";
		public static final String sign_In_btn3 = "gwm-SignIn-button"; 
				 

		public static final String email_Login_txtbx = "ap_email_login";   
