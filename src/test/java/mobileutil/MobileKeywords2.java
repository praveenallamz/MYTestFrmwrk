...
public class MobileKeywords2 {
	...
	public static void scrollAndClick(String visibleText) {
	     GlobalUtil.mdriver.findElementByAndroidUIAutomator("new UiScrollable(new UiSelector().scrollable(true).instance(0)).scrollIntoView(new UiSelector().textContains(\""+visibleText+"\").instance(0))").click();
	        }
	...
	////// ramesh //////
	  ...
	  { 
		  try { 
			  ...
			  {
				  if (isElementDisplayed(element)) { break; }
				  else { swipeUp(); } }
		 } catch(Exception e) 
